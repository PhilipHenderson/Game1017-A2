...
void PauseState::Enter()
{
	...
	m_resumeBtn = new PlayButton({ 0,0,400,100 }, { 312.0f,100.0f,400.0f,100.0f },
...
void GameState::Update()
{
	...
	if (EVMA::KeyHeld(SDL_SCANCODE_E))
...
void TitleState::Enter()
{
	...
	m_quitBtn = new QuitButton({ 0,0,400,100 }, { 312.0f,100.0f,400.0f,100.0f },
